...
const char *metric_names[] = {"apo", "apd", "ims", "hp"};
MetricFunc metrics[] = {apo, apd, ims, hp};
...
int main(int argc, char *argv[]) {
    ...
    for (int i = 2; i < argc; i++) {
        ...
        // First: check metrics handled via function pointers
        ...
        // Then: check metrics handled via direct function calls
        if (!handled) {
